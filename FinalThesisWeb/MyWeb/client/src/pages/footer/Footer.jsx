...
export const Footer = () => {
    ...
    return (
        <Box h={'300px'} bg={'black'} color={'white'} mt={'40px'}>
            ...
            <Center h={'80px'}>
                {/* <Text className="typeWritertheme">Made with <Icon as={FcLike} /> by Andy Tran</Text> */}
            </Center>
            ...
            >
                ...
                >
                    <IconLink
                        ...
                        link={"https://github.com/LEO1702?tab=repositories"}
                        />
                    <IconLink
                        icon={FaGithub}
                        link={"https://github.com/LEO1702"}
                        />
                    <IconLink
                        icon={FaLinkedin}
                        link={"https://www.linkedin.com/in/dat-tran-261059202/"}
                        />
                </Flex>
