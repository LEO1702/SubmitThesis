            ...
            <AccordionItem>
                ...
                <AccordionPanel pb={4}>
                    ...
                    <Flex m={'2%'} direction={'column'} gap={2} >
                        <Input onChange={handleChange} fontSize={['13px', '16px']} type={'number'} name="minPrice" placeholder="USD min price" />
                        <Input onChange={handleChange} fontSize={['13px', '16px']} type={'number'} name="maxPrice" placeholder="USD max price" />
