        ...
        <>
            <Box py={'15px'} px={'25px'}>
                ...
                <Flex flexDirection={'column'} gap={'5px'} my={'20px'} fontSize={'18px'}>
                    ...
                    <OrderPageText name={'Subtotal'} value={`USD ${numberWithCommas(subTotal)}.00`} />

                    <OrderPageText name={'Quantity'} value={quantity} />

                    <Flex justifyContent={'space-between'}>
                        <Text >Estimated Delivery</Text>
                        <Text title={'Free delivery applies to orders of USD 140,0 or more'} cursor={'pointer'}>
                            USD {numberWithCommas(shipping)}.00
                        </Text>
                    </Flex>

                    <OrderPageText name={'Discount'} value={`USD ${numberWithCommas(discount)}.00`} />

                    <Divider my={'10px'} />

                    <OrderPageText name={'Total'} value={`USD ${numberWithCommas(total)}.00`} />
